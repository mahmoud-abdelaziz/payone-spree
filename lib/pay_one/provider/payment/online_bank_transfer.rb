...
module PayOne
  module Provider
    module Payment
      class OnlineBankTransfer < PayOne::Provider::Payment::Base
        ...
        def set_online_bank_transfer_request_parameters(request, online_bank_transfer_source)
          ...
          case request.onlinebanktransfertype
            when PayOne::Utils::OnlineBankTransferType::INSTANT_MONEY_TRANSFER
              request.bankaccount= online_bank_transfer_source.bank_account
              request.bankcode= online_bank_transfer_source.bank_code
            when PayOne::Utils::OnlineBankTransferType::GIROPAY
              request.bankaccount= online_bank_transfer_source.bank_account
              request.bankcode= online_bank_transfer_source.bank_code
            when PayOne::Utils::OnlineBankTransferType::ONLINE_TRANSFER
              request.bankgrouptype= online_bank_transfer_source.bank_group_type
            when PayOne::Utils::OnlineBankTransferType::IDEAL
              request.bankgrouptype= online_bank_transfer_source.bank_group_type
          end
        end
        ...
        def online_bank_transfer_type(online_bank_transfer_source)
          type = PayOne::Utils::OnlineBankTransferType.validate(online_bank_transfer_source.online_bank_transfer_type)
          if type != nil
            return type
          else
            return ''
