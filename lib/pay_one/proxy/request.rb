...
module PayOne
  module Proxy
    class Request < ParameterContainer
      ...
      parameter_value_accessor :visa_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::VISA
      parameter_value_accessor :mastercard_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::MASTERCARD
      parameter_value_accessor :amex_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::AMEX
      parameter_value_accessor :diners_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::DINERS
      parameter_value_accessor :jbc_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::JBC
      parameter_value_accessor :maestro_international_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::MAESTRO_INTERNATIONAL
      parameter_value_accessor :discover_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::DISCOVER
      parameter_value_accessor :carte_bleue_cardtype, :cardtype, ::PayOne::Utils::CreditCardType::CARTE_BLEUE
      
      # Specific values for :addresschecktype parameter
      parameter_value_accessor :basic_addresschecktype, :addresschecktype, ::PayOne::Utils::AddressCheckType::BASIC
      parameter_value_accessor :person_addresschecktype, :addresschecktype, ::PayOne::Utils::AddressCheckType::PERSON
      parameter_value_accessor :no_addresschecktype, :addresschecktype, ::PayOne::Utils::AddressCheckType::NO
      
      # Specific values for :consumerscoretype parameter
      parameter_value_accessor :ih_consumerscoretype, :consumerscoretype, ::PayOne::Utils::ConsumerScoreType::IH
      parameter_value_accessor :ia_consumerscoretype, :consumerscoretype, ::PayOne::Utils::ConsumerScoreType::IA
      parameter_value_accessor :ib_consumerscoretype, :consumerscoretype, ::PayOne::Utils::ConsumerScoreType::IB
      
      # Specific values for :storecarddata parameter
      parameter_value_accessor :yes_storecarddata, :storecarddata, ::PayOne::Utils::StoreCardData::YES
      parameter_value_accessor :no_storecarddata, :storecarddata, ::PayOne::Utils::StoreCardData::NO
      ...
      def send
        ...
        response = PayOne::Proxy::Response.new
